...
const Page = ({ children }) => {
    return (
        <div className='min-h-screen h-auto bg-slate-300 flex flex-col justify-between '>
            ...
            <footer className="w-full h-60 md:h-52 bg-black p-10 text-white">
                ...
                <p className='w-full text-center mt-8 md:mt-0 font-fgrotesque text-sm md:text-lg font-bold '>Tzuzul Bootcamp 2022 &copy; Nahum Casco</p>
            </footer>
        </div>
    )
}
